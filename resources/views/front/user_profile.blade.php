			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="crumbs">
						...
						<a href="#">الاعضاء</a>
						<span class="crumbs-span">/</span>
						<span class="current">الملف الشخصي : admin</span>
					</div>
				</div>
			</div><!-- End row -->
						...
						<div class="col-md-12">
							<div class="page-content">
								...
								<div class="ul_list ul_list-icon-ok about-user">
									<ul>
										<li class="registe-user"><i class="icon-plus"></i>تاريخ التسجيل : <span>فبراير 10, 2019</span></li>
										<li><i class="icon-map-marker"></i>البلد : <span>Gaza</span></li>
				...
				<div class="page-content">
					<div class="user-stats">
						...
						<div class="user-stats-item user-stats-item-last">
							<div class="block-stats-1">الزيارات</div>
